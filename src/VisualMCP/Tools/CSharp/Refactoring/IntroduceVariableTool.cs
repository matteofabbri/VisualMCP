...
public static class IntroduceVariableTool
{
    ...
    public static async Task<object> IntroduceVariable(
        ...
        [Description("Dry run â€” show the change without writing to disk (default: false)")] bool dryRun = false)
    {
        ...
        if (enclosingStatement is null)
            return new { error = "The expression is not inside a statement â€” cannot introduce a variable here." };
