...
/// <summary>Implementation for the docker_status MCP command.</summary>
internal static class DockerStatusImpl
{
    internal static async Task<object> RunAsync(bool includeStopped)
    {
